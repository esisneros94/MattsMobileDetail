...
namespace MattMobileDetail
{
    public class EncryptionSupplier
    {
        ...
        public static byte[] EncryptionString(string data)
        {
            ...
            memoryStream.Write(algo.IV, 0, algo.IV.Length);

            CryptoStream myCrypto = new CryptoStream(memoryStream, algo.CreateEncryptor(), CryptoStreamMode.Write);
        ...
        {
            return Convert.ToBase64String(EncryptionString(data));
        }
