            ...
            <div class="row" style="border: 1px solid black;">
                <div>
                    ...
                    <div id="demo" class="collapse">
                        <div style="margin: 10px 0px;">Prices range from $50 to $140 depending on what package is chosen. <a href="Services">Services Page</a> </div>
                ...
                <div>
                    ...
                    <div id="demo2" class="collapse">
                        <div style="margin: 10px 0px;">
                            Visit services page to see the specific package details. <a href="Services">Services Page</a>
                        </div>
                    </div>
                </div>
                <div>
                ...
                <div>
                    ...
                    <div id="demo6" class="collapse">
                        ...
                        my weekly schedule. <a href="ScheduleAppointment">Appointment Page</a>
                        </div>
                    </div>
                </div>
                <div>
